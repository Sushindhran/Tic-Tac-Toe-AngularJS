describe("view.content.AboutController", function () {
    ...
    describe("ABOUT TEXT",function(){
       it("About text should not be null",function(){
           expect(controller.aboutText).not.toBe(null);
       });
    });
});